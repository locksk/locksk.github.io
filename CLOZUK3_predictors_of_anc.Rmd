...
```{r remove this chunk, include = FALSE}
print.data.frame(parameterestimates(fit1), digits = 6)
print.data.frame(out_1med, digits = 6)
print.data.frame(parameterestimates(fit2), digits = 6)
print.data.frame(out_4med, digits = 6)
```
